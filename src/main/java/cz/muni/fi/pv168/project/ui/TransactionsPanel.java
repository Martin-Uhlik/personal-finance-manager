...
public class TransactionsPanel extends JPanel {
    ...
    public TransactionsPanel() {
        ...
        addAction = new AddAction(employeeTable, departmentListModel, 0);
        ...
        resetFilterAction = new ResetFilterAction(employeeTable, testDataGenerator, departmentListModel); //TODO
    ...
    private JTable createEmployeeTable(List<Transaction> transactions) {
        var model = new TransactionTableModel(transactions);
    ...
    /**
     * Decides if buttons "Edit", "Delete" and "Details" are enabled
     *
